...
public:
    ...
    Planet(std::string name, GLfloat *mesh, const QMatrix4x4 &rotation ,const QMatrix4x4 orbit,
           const QMatrix4x4 orbit_rotation)
        : name(name), mesh(mesh), rotation(rotation), orbit(orbit), orbit_rotation(orbit_rotation) {}
